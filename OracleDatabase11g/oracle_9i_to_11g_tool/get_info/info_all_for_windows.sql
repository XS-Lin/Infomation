...
REM   #################################################################
SPOOL '&infodir\table_&sid..csv'

PROMPT OWNER,TABLE_NAME,TABLESPACE,LAST_ANALYZED,PCT_FREE,PCT_USED,INITIAL_EXT,NEXT_EXT,PCT_INC,MIN_EXT,MAX_EXT,NUM_ROWS,BLOCKS,EMPTY_BLOCKS,AVG_SPACE,CHAIN_CNT,AVG_ROW_LEN,COMPRESSION
SELECT
        OWNER               ||','||
        TABLE_NAME          ||','||
        TABLESPACE_NAME     ||','||
...
SPOOL '&infodir\tenki_objects_&sid..csv'
...
SPOOL '&infodir\tenki_dba_synonyms_&sid..csv'
...
REM SPOOL '&infodir\tenki_tab_privs_&sid..csv
...
SPOOL '&infodir\triggers_&sid..csv'
